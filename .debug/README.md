...
tree. The 94 briefs below cover tool hardening and the subsequent agent/process
recovery work. Numeric IDs are stable creation order.

## Current queue

**The queue is not fully closed:** 91 briefs are Closed, Fixed, or Resolved;
061 is Implemented with a documented execution boundary; 048 and 054 remain
Partial. No brief currently has an OPEN status.
