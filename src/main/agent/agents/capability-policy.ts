...
const GITHUB_GROUPS: Record<string, string[]> = {
  ...
  browser_advanced: CATEGORY_TOOLS.browser_advanced,
...
const GITHUB_TOOLS: Record<string, string[]> = {
  ...
  "search/codebase": CATEGORY_TOOLS.navigation,
  "web/fetch": ["web_fetch"],
  "web/search": ["web_search"],
  "vscode/askQuestions": ["ask_user_question"],
  "read/problems": ["workspace_diagnostics"],
  "vscodeGeneral/usages": ["find_references"],
  "vscodeGeneral/definitions": ["go_to_definition"],
  "vscodeGeneral/hover": ["hover_type"],
  "vscodeGeneral/symbols": ["workspace_symbols", "document_symbols"],
  ...
  "read/sourceControl": CATEGORY_TOOLS.git_read,
  "vscodeGeneral/sourceControl": CATEGORY_TOOLS.git_read,
  "vscodeGeneral/git": CATEGORY_TOOLS.git_read,
  ...
  "browser/handleDialog": ["browser_handle_dialog"],
  "browser/dialog": ["browser_handle_dialog"],
  "browser/back": ["browser_back"],
  "browser/close": ["browser_close"],
  "browser/handoff": ["browser_handoff"],
  "browser/evaluate": CATEGORY_TOOLS.browser_advanced,
