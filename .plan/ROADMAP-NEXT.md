...
1. **`106.5` — Mission Control: worktrees, merge queue, mission merge policy.** Worktree per slice off
...
2. **`106.6` — Mission Control: Navigator and autonomous drive.** Deterministic, restart-safe Navigator
    ...
    with auto-pause.
3. **`106.7` — Mission Control: Refocus, follow-ups, seat memory.** Intent-chain reminders at kickoff,
...
4. **`106.8` — Mission Control: health monitoring.** Progress vs ceremony event classification,
...
5. **`106.9` — Mission Control: Processes sunset.** Parity checklist, import Processes as playbooks,
