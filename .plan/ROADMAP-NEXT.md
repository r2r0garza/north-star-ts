...
1. **`033.4` — Agent-readable live dashboards. DISCUSSION REQUIRED BEFORE IMPLEMENTATION.** Add a
...
2. **`104` — Deterministic command phases.** Let a Process phase execute a persisted, user-reviewed
...
3. **`105` — Required skills for individual Process phases.** Let an agent phase explicitly activate one
